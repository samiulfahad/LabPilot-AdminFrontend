    ...
    <div className="min-w-full border border-gray-200 rounded-xl bg-white shadow-sm hover:shadow-md transition-all duration-300 px-4 sm:px-6 py-5 mb-5">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-4">
        <div className="flex items-center justify-between sm:justify-start gap-4 w-full sm:w-auto">
          ...
          {/* Mobile Action Buttons - Now includes Add Subzone */}
          <div className="flex items-center gap-2 sm:hidden flex-shrink-0">
            <button
              onClick={onAddSubZone}
              className="flex items-center justify-center gap-2 px-3 py-2.5 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl font-medium hover:from-green-600 hover:to-emerald-700 transition-all duration-200 shadow-sm text-sm"
              title="Add Subzone"
            >
        ...
        <div className="hidden sm:flex items-center gap-2 flex-shrink-0">
          {/* Add Subzone Button - Now icon only */}
          <button
            onClick={onAddSubZone}
            className="flex items-center justify-center gap-2 px-3 py-2.5 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl font-medium hover:from-green-600 hover:to-emerald-700 transition-all duration-200 shadow-sm text-sm"
            title="Add Subzone"

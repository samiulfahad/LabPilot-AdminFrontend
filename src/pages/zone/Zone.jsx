    ...
    <div className="min-w-full border border-gray-200 rounded-xl bg-white shadow-sm hover:shadow-md transition-all duration-300 px-4 sm:px-6 py-5 mb-5">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-4">
        <div className="flex items-center justify-between sm:justify-start gap-4 w-full sm:w-auto">
          ...
          {/* Edit and Delete Buttons - Right side for mobile */}
        ...
        {/* Action Buttons - Modern Design for Desktop and Add Subzone for mobile */}
        <div className="flex flex-col xs:flex-row gap-3 flex-shrink-0 w-full sm:w-auto">
          {/* Add Subzone Button - Now visible on mobile */}
          <button
            onClick={onAddSubZone}
            className="flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl font-medium hover:from-green-600 hover:to-emerald-700 transition-all duration-200 shadow-sm hover:shadow-md text-sm w-full sm:w-auto"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

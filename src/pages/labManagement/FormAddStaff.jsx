...
const AddStaff = () => {
  ...
  return (
    <div className="space-y-1 p-2 pt-0">
      ...
      {/* Input Fields */}
      <InputField label="Name" name="name" value={staffForm.name || ""} onChange={handleFieldChange} />

      <InputField label="Username" name="username" value={staffForm.username || ""} onChange={handleFieldChange} />
      ...
      <InputField label="Email" name="email" type="email" value={staffForm.email || ""} onChange={handleFieldChange} />

      <InputField label="Phone" name="phone" type="tel" value={staffForm.phone || ""} onChange={handleFieldChange} />

  ...
  return (
    <>
      ...
      <div className="lg:hidden">
        {/* Fixed Navbar */}
        <nav
          className={`fixed top-0 left-0 right-0 z-50 flex justify-between items-center py-3 px-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200 transition-all duration-300 ${
